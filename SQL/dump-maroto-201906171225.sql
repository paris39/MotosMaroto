...
CREATE TABLE `accesory` (
  ...
  `size` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Talla',
...
CREATE TABLE `accesory_type` (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de accesorio',
...
CREATE TABLE `bike` (
  ...
  `frame` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Cuadro',
  `fork` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Horquilla',
  `brakes` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Frenos',
  `wheels` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Llanta / rueda',
  `tyres` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Neumáticos',
  `seat` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Sillín',
  `handlebars` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Manillar',
  `shift` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Sistema de cambio',
  `derailleur` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Desviador del cambio',
  `twist_shifters` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Mandos del cambio',
  `speed_groupset` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Grupo',
  `weight` decimal(10,0) unsigned DEFAULT NULL COMMENT 'Peso de la bicicleta (kg)',
  `pedals` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Pedales',
  `cranks` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Bielas',
  `cassette` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Cassette',
...
CREATE TABLE `bike_size` (
  ...
  `name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre de la talla de la bicicleta',
...
CREATE TABLE `bike_type` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de bicicleta',
...
CREATE TABLE `color` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del color',
  `original_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Nombre original (inglés) del color',
...
CREATE TABLE `equipment_size` (
  ...
  `name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre de la talla de equipamiento',
...
CREATE TABLE `equipment_type` (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de equipación',
...
CREATE TABLE `gender` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del género',
...
CREATE TABLE `image` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Nombre de la imagen',
  `url` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'URL de la imagen',
...
CREATE TABLE `moto` (
  ...
  `number_plate` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Matrícula de la moto',
  `power` float DEFAULT NULL COMMENT 'Potencia de la moto',
  `power_unit` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Unidad de potencia de la moto (cv, kW, hp...)',
  ...
  `gears` int(10) unsigned DEFAULT NULL COMMENT 'Velocidades / Marchas',
  `front_brake` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Freno delantero',
  `rear_brake` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Freno trasero',
...
CREATE TABLE `moto_contamination` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del distintivo de contaminación de la moto',
  `color` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Color del distintivo de contaminación de la moto',
...
CREATE TABLE `moto_fuel` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del combustible de la moto',
...
CREATE TABLE `moto_license` (
  ...
  `name` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del carnet de conducir',
  `observations` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci COMMENT 'Observaciones sobre el carnet de conducir',
...
CREATE TABLE `moto_transmission` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de transmisión de la moto',
...
CREATE TABLE `moto_type` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de moto',
...
CREATE TABLE `other_type` (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre del tipo de otros',
...
CREATE TABLE `product` (
  ...
  `name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre comercial del producto',
  `mark` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Marca del producto',
  `model` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Modelo del producto',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci COMMENT 'Descripción detallada del producto',
  ...
  `observations` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci COMMENT 'Observaciones (alquiler, venta...)',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci COMMENT='Productos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product` VALUES (1,'Desbrozadora','Ducati','C250','Desbrozadora potente',200,5,3,1,0,'',1,'2012-01-01','2019-04-26 10:05:51','2019-04-26 10:05:51'),(2,'Honda Transalp XL700V','Honda','Transalp XL700V','Honda Transalp XL700V',4000,2,2,1,0,'Tragamillas',0,'2010-01-01','2019-05-13 14:07:05',NULL);
...
CREATE TABLE `product_category` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre de la subcategoría del producto',
...
CREATE TABLE `product_subcategory` (
  ...
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Nombre de la categoría del producto',
...
INSERT INTO `products_colors` VALUES (2,8,'2019-06-06 12:52:15',NULL),(2,11,'2019-06-06 12:52:15',NULL),(2,12,'2019-06-06 12:52:15',NULL);
...
INSERT INTO `products_images` VALUES (2,1,1,1,'2019-05-29 14:20:08',NULL),(2,2,NULL,1,'2019-06-03 13:12:25',NULL),(2,3,NULL,1,'2019-06-03 13:11:54',NULL),(2,4,NULL,1,'2019-06-03 13:11:54',NULL),(2,5,NULL,1,'2019-06-03 13:11:54',NULL),(2,6,NULL,1,'2019-06-05 14:03:06',NULL);
...
CREATE TABLE `user` (
  ...
  `nick` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Alias del usuario',
  `name` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Nombre del usuario',
  `surname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL COMMENT 'Apellidos del usuario',
  `password` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL COMMENT 'Contraseña de acceso del usuario',
...
-- Dump completed on 2019-06-17 12:25:33
