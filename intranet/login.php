    	...
    	<div class="container-fluid p-0">
    		<section class="resume-section p-3 p-lg-5 d-flex d-column" id="login">
    			<div class="my-auto">
        			...
        			<form id="loginForm" name="loginForm" method="post" action="./content/check.php" onSubmit="return validate();">	
        				<div class="row">
        					<div class="col-lg-12">
        						<div class="form-group">
        							<input class="form-control" id="user" name="user" type="text" placeholder="Nombre *" required="required" data-validation-required-message="Por favor, introduzca su nombre." />
        							<p class="help-block text-danger"></p>
        						</div>
        						<div class="form-group">
        							<input class="form-control" id="password" name="password" type="password" placeholder="Contrase&ntilde;a *" required="required" data-validation-required-message="Por favor, introduzca su contraseña." />
        							<p class="help-block text-danger"></p>
        						</div>
        					</div>
        					<div class="col-lg-12 text-center">
        						<div id="success"></div>
        						<button id="loginButton" class="btn btn-primary btn-xl text-uppercase" type="submit">Enviar</button>
...
?>
	...
	<body>
		<div class="container-fluid p-0">
    		<section class="resume-section p-3 p-lg-5 d-flex d-column" id="checkuser">
				<div class="my-auto">
					<p class="lead mb-5">
    					Cargando...
    				</p>
