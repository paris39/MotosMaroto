 ...
 */
	 ...
	 * />' . "\n";
	 * echo ' <title>INTRANET - Modificar Producto - Bicicletas y Motos
	 * Maroto</title>' . "\n";
	 * echo ' <link rel="icon" type="image/x-icon"
	 * href="../../../img/mm_logo.ico" />' . "\n";
	 * echo ' <script src="../../content/js/intranet.js"
...
echo '<textarea class="form-control" name="description"
																	...
																	data-validation-required-message="Por favor, introduzca una descripci&oacute;n.">' . $productDto->getDescription() . '</textarea>' . "\n";
?>
														</div>
														<div class="form-group">
...
echo '<textarea class="form-control" name="observations"
																	...
																	data-validation-required-message="Por favor, introduzca observaciones.">' . $productDto->getObservations() . '</textarea>' . "\n";
?>
														</div>
														<div class="form-group">
...
for ($i = 0; $i < $bikeTypeList->count(); $i ++) {
	...
	if (null != $productDto->getDetails() && SUB_BIKE == $productDto->getCategory()->getId() && BIKE == $productDto->getSubcategory()->getId() && null != $productDto->getDetails()->getType() && $bikeTypeDtoAux->getId() == $productDto->getDetails()
		->getType()
		->getId()) {
...
// Cuadro
if (null != $bikeAux) {
	echo '<input class="form-control" type="text" name="bikeGears" title="Velocidades de la bicicleta"
...
for ($i = 0; $i < $motoTypeList->count(); $i ++) {
	...
	if (null != $productDto->getDetails() && SUB_MOTO == $productDto->getCategory()->getId() && MOTO == $productDto->getSubcategory()->getId() && null != $productDto->getDetails()->getType() && $motoTypeDtoAux->getId() == $productDto->getDetails()
		->getType()
		->getId()) { // TODO JPD
