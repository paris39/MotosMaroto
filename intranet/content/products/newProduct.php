												...
												<div class="col-md-6">
													<div class="form-group">
														<div class="productImg">
															<span>Im&aacute;genes:</span> <input class="form-control"
													...
													<div class="form-group">
														<span>&iquest;Mostrar en web?</span> <input
															type="checkbox" name="show" id="show" checked="checked" />
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<span>Categor&iacute;a:</span> <select
															name="productCategory" class="form-control"
															id="productCategory" title="Categor&iacute;a"
															onChange="showProductCategory(this);">
