		    									...
		    									<div class="row">
					    							<div class="col-md-6">
					    								<div class="form-group">
					    									<input type="search" class="form-control short" id="id" name="id" placeholder="ID" />
					    								</div>
					    								<div class="form-group">
					    									<input type="search" class="form-control" id="name" name="name" placeholder="Nombre" />
					    								</div>
					    							</div>
					    							<div class="col-md-6">
					    								<div class="form-group">
						    								<div class="form-group noBlock">
																...
																<select name="productCategory" class="form-control short noBlock" id="productCategory" title="Categor&iacute;a" onChange="showSubtypeCategory(this);">
															...
															<!-- SUBCATEGORÍAS -->
															<div class="form-group subtypeCategory noBlock" id="exampleSubType">
															...
															<div class="form-group subtypeCategory noBlock" id="otherSubType">
																<select name="otherSubType" class="form-control short noBlock" id="cbOtherSubType" title="Tipo de Otros">
																	<option value="none">Seleccionar tipo...</option>
														...
														<div class="form-group">
					    									<input type="search" class="form-control" id="mark" name="mark" placeholder="Marca" />
					    								</div>
					    							</div>
					    						</div>
					    					</div>
